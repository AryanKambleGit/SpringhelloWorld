...
//    }
    ...
    //Now I learniing about the JPQL Methods So their test cases

    @Test
    public void testTransactionMethod() {
        //     bY BloodGroupQuery
        //        List<Patient > patientList = patientRepository.findByBloodGroupQuery(BloodGroup.A_POSITIVE);

        // By BYBornAferrDate
//        List<Patient> patientList1 = patientRepository.findBornAfterDate(LocalDate.of(1988, 3, 4));
//
//        for (Patient patient : patientList1) {
//            System.out.println(patient);
//        }

      //  List<Patient> patients = patientRepository.findBornBeforeDate(LocalDate.of(2000, 3, 4));

        List<Patient> patients = patientRepository.findByGenderAndBloodGroup(Gender.FEMALE, BloodGroup.B_NEGATIVE);
